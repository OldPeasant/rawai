...
COPY /frontend/dist/rawai-report/* /usr/share/rawai/static/
COPY /frontend/public* /usr/share/rawai/static/

RUN pip3 install -r /usr/share/rawai/requirements.txt

EXPOSE 5000

CMD ["python","/usr/share/rawai/rawai-report.py", "/var/rawai", "dummyno"]
